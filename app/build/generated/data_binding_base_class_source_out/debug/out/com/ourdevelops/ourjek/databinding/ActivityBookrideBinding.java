...
public final class ActivityBookrideBinding implements ViewBinding {
  ...
  private ActivityBookrideBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageView backBtn,
      @NonNull ImageView background, @NonNull ImageView backgroundstripe,
      @NonNull LinearLayout bottomSheet, @NonNull Button_SF_Pro_Display_Medium btnConfirm,
  ...
  public static ActivityBookrideBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_bookride, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityBookrideBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBookrideBinding((CoordinatorLayout) rootView, backBtn, background,
