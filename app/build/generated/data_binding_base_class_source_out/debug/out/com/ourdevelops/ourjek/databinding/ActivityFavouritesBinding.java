...
public final class ActivityFavouritesBinding implements ViewBinding {
  ...
  private ActivityFavouritesBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgBack,
      @NonNull ImageView nodataimage, @NonNull RecyclerView recyclerView,
  ...
  public static ActivityFavouritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFavouritesBinding((RelativeLayout) rootView, imgBack, nodataimage,
          recyclerView, rlnodata, rlprogress, toolbar);
    }
