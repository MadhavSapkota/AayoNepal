...
public final class ActivityMyAddressBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView myAddressesRv;

  private ActivityMyAddressBinding(@NonNull ConstraintLayout rootView,
      @NonNull Toolbar appBarLayout, @NonNull ImageView backBtnVerify,
      @NonNull RecyclerView myAddressesRv) {
  ...
  public static ActivityMyAddressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView myAddressesRv = rootView.findViewById(id);
      if (myAddressesRv == null) {
        break missingId;
      }

      return new ActivityMyAddressBinding((ConstraintLayout) rootView, appBarLayout, backBtnVerify,
          myAddressesRv);
    }
