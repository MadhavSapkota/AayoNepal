...
public final class ActivityNewBookrideBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageView destination;
  ...
  @NonNull
  public final LinearLayout llPinonmap;

  @NonNull
  public final LinearLayout llRidelist;
  ...
  @NonNull
  public final TextViewSFProDisplayMedium locationPickerAutoCompleteText;
  ...
  @NonNull
  public final TextViewSFProDisplayRegular tvPlaceName;

  @NonNull
  public final TextViewSFProDisplayMedium walletpayment;

  private ActivityNewBookrideBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ImageView backBtn, @NonNull ImageView background,
      @NonNull ImageView backgroundstripe, @NonNull LinearLayout bottomSheet,
      ...
      @NonNull ImageView destination, @NonNull Button_SF_Pro_Display_Medium destinationButton,
      ...
      @NonNull ImageView info, @NonNull ImageView ivFav,
      ...
      @NonNull LinearLayout llPinonmap, @NonNull LinearLayout llRidelist,
      @NonNull LinearLayout llShowDetail, @NonNull LinearLayout llchat,
      ...
      @NonNull LinearLayout llestimated, @NonNull LinearLayout lllayananall,
      @NonNull LinearLayout lllogo, @NonNull LinearLayout llpayment,
      @NonNull TextViewSFProDisplayMedium locationPickerAutoCompleteText, @NonNull ImageView logo,
      ...
      @NonNull RelativeLayout rlprogress, @NonNull RecyclerView rvLocationList,
      @NonNull RecyclerView rvRideList, @NonNull TextViewSFProDisplayMedium saldo,
      ...
      @NonNull TextViewSFProDisplayRegular tvPlaceName,
    ...
    this.llPinonmap = llPinonmap;
    this.llRidelist = llRidelist;
  ...
  @NonNull
  public static ActivityNewBookrideBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityNewBookrideBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_new_bookride, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityNewBookrideBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.destination;
      ImageView destination = rootView.findViewById(id);
      if (destination == null) {
        break missingId;
      }
      ...
      id = R.id.ll_pinonmap;
      LinearLayout llPinonmap = rootView.findViewById(id);
      if (llPinonmap == null) {
        break missingId;
      }

      id = R.id.ll_ridelist;
      LinearLayout llRidelist = rootView.findViewById(id);
      if (llRidelist == null) {
        break missingId;
      }
      ...
      TextViewSFProDisplayMedium locationPickerAutoCompleteText = rootView.findViewById(id);
      ...
      RecyclerView rvLocationList = rootView.findViewById(id);
      if (rvLocationList == null) {
        break missingId;
      }

      id = R.id.rvRideList;
      RecyclerView rvRideList = rootView.findViewById(id);
      if (rvRideList == null) {
        break missingId;
      }
      ...
      id = R.id.tvPlaceName;
      TextViewSFProDisplayRegular tvPlaceName = rootView.findViewById(id);
      if (tvPlaceName == null) {
        break missingId;
      }
      ...
      return new ActivityNewBookrideBinding((CoordinatorLayout) rootView, backBtn, background,
          backgroundstripe, bottomSheet, btnConfirm, btnpromo, cashPayment, chat, checkedcash,
          checkedwallet, cost, costText, destination, destinationButton, destinationContainer,
          destinationText, detail, diskon, distance, fitur, idswipe, image, info, ivFav, ketsaldo,
          layanan, layananall, layanandes, llPinonmap, llRidelist, llShowDetail, llchat,
          llcheckedcash, llcheckedwallet, lldestination, lldistance, llestimated, lllayananall,
          lllogo, llpayment, locationPickerAutoCompleteText, logo, merchantdetail, merchantnear,
          order, phonenumber, pickUpButton, pickUpContainer, pickUpText, price, produk,
          profileimage, promocode, promonotif, receivername, receiverphone, rlayout, rlayoutstripe,
          rlnotif, rlprogress, rvLocationList, rvRideList, saldo, senddetail, sendername,
          senderphone, space, status, textnotif, textprogress, time, topUp, totaltext, tvPlaceName,
          walletpayment);
    }
