...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  private ActivityPrivacyBinding(@NonNull RelativeLayout rootView, @NonNull LinearLayout adView,
      @NonNull ImageView backBtn, @NonNull FrameLayout header, @NonNull Toolbar toolbar,
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyBinding((RelativeLayout) rootView, adView, backBtn, header, toolbar,
          webView);
    }
