...
public final class ActivityRentBinding implements ViewBinding {
  ...
  @NonNull
  public final Button_SF_Pro_Display_Medium duabelasjam;

  @NonNull
  public final Button_SF_Pro_Display_Medium enamjam;
  ...
  @NonNull
  public final Button_SF_Pro_Display_Medium satuhari;
  ...
  private ActivityRentBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageView backBtn,
      ...
      @NonNull TextViewSFProDisplayRegular cost, @NonNull LinearLayout detail,
      @NonNull TextViewSFProDisplayRegular diskon,
      @NonNull Button_SF_Pro_Display_Medium duabelasjam,
      @NonNull Button_SF_Pro_Display_Medium enamjam, @NonNull TextViewSFProDisplayRegular fitur,
      @NonNull View idswipe, @NonNull ImageView image,
      ...
      @NonNull CircleImageView profileimage, @NonNull EditTextSFProDisplayMedium promocode,
      @NonNull TextViewSFProDisplayMedium promonotif, @NonNull RelativeLayout rlayout,
      ...
      @NonNull Button_SF_Pro_Display_Medium satuhari, @NonNull Space space,
      ...
      @NonNull TextViewSFProDisplayMedium topUp,
    ...
    this.detail = detail;
    this.diskon = diskon;
    this.duabelasjam = duabelasjam;
    this.enamjam = enamjam;
    this.fitur = fitur;
  ...
  public static ActivityRentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.duabelasjam;
      Button_SF_Pro_Display_Medium duabelasjam = rootView.findViewById(id);
      if (duabelasjam == null) {
        break missingId;
      }

      id = R.id.enamjam;
      Button_SF_Pro_Display_Medium enamjam = rootView.findViewById(id);
      if (enamjam == null) {
        break missingId;
      }
      ...
      id = R.id.satuhari;
      Button_SF_Pro_Display_Medium satuhari = rootView.findViewById(id);
      if (satuhari == null) {
        break missingId;
      }
      ...
      return new ActivityRentBinding((CoordinatorLayout) rootView, backBtn, background,
          backgroundstripe, bottomSheet, btnpromo, cashPayment, chat, checkedcash, checkedwallet,
          cost, detail, diskon, duabelasjam, enamjam, fitur, idswipe, image, ketsaldo, layanan,
          layanandes, llchat, llcheckedcash, llcheckedwallet, lllogo, llpayment, logo, order,
          phonenumber, pickUpButton, pickUpContainer, pickUpText, price, profileimage, promocode,
          promonotif, rlayout, rlayoutstripe, rlnotif, rlprogress, saldo, satuhari, space, status,
          textnotif, textprogress, time, topUp, walletpayment);
    }
