...
public final class ActivityRideNewBottomSheetBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRideNewBottomSheetBinding(@NonNull CardView rootView, @NonNull TextView asd,
      @NonNull CircularImageView background, @NonNull ImageView backgroundstripe,
      ...
      @NonNull TextView destinationText, @NonNull LinearLayout detail, @NonNull TextView diskon,
      @NonNull TextView distance, @NonNull AppCompatButton fabSupport, @NonNull TextView fitur,
      @NonNull ImageView greenCircle, @NonNull View idswipe, @NonNull CircularImageView image,
      ...
      @NonNull LinearLayout llpayment, @NonNull LinearLayout loutServiceComission,
      @NonNull LinearLayout merchantdetail, @NonNull RecyclerView merchantnear,
      @NonNull MaterialButton order, @NonNull OrderStatusStepperBinding orderStepper,
      @NonNull ImageView phonenumber, @NonNull TextView pickUpText, @NonNull TextView pickupTxt,
      @NonNull TextView price, @NonNull TextViewSFProDisplayRegular produk,
      ...
      @NonNull RelativeLayout rlayoutstripe, @NonNull TextViewSFProDisplayMedium saldo,
      @NonNull LinearLayout senddetail, @NonNull TextViewSFProDisplayRegular sendername,
      @NonNull Button_SF_Pro_Display_Medium senderphone, @NonNull TextViewSFProDisplayMedium topUp,
      @NonNull TextView totaltext, @NonNull TextView tvComission, @NonNull TextView tvDeliveryFee,
      @NonNull TextView tvServicecharge, @NonNull TextView walletpayment,
  ...
  @NonNull
  public static ActivityRideNewBottomSheetBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRideNewBottomSheetBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ride_new_bottom_sheet, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRideNewBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRideNewBottomSheetBinding((CardView) rootView, asd, background,
          backgroundstripe, btnpromo, cashPayment, checkedcash, checkedwallet, cost, costText,
          dashFour, dashOne, dashThree, dashTwo, destinationText, detail, diskon, distance,
          fabSupport, fitur, greenCircle, idswipe, image, info, ketsaldo, layanan, layanandes,
          llPromoUse, llVat, llchat, llcheckedcash, llcheckedwallet, lldestination, lldistance,
          llestimated, lllayananall, llpayment, loutServiceComission, merchantdetail, merchantnear,
          order, binding_orderStepper, phonenumber, pickUpText, pickupTxt, price, produk, promocode,
          promonotif, receivername, receiverphone, redCircle, rlayoutstripe, saldo, senddetail,
          sendername, senderphone, topUp, totaltext, tvComission, tvDeliveryFee, tvServicecharge,
          walletpayment, wrapperOne);
    }
