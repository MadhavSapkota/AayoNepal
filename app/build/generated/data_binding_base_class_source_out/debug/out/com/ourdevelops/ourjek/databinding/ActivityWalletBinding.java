...
public final class ActivityWalletBinding implements ViewBinding {
  ...
  private ActivityWalletBinding(@NonNull RelativeLayout rootView, @NonNull ImageView backBtn,
      @NonNull FrameLayout header, @NonNull ImageView nodataimage, @NonNull RecyclerView recycle,
  ...
  public static ActivityWalletBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.recycle;
      RecyclerView recycle = rootView.findViewById(id);
      if (recycle == null) {
        break missingId;
      }
      ...
      return new ActivityWalletBinding((RelativeLayout) rootView, backBtn, header, nodataimage,
          recycle, rlnodata, rlprogress, toolbar);
    }
