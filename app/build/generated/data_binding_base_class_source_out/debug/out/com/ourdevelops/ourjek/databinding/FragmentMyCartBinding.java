...
public final class FragmentMyCartBinding implements ViewBinding {
  ...
  public static FragmentMyCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMyCartBinding((RelativeLayout) rootView, backgroundstripe, btnpromo,
          cashPayment, checkedcash, checkedwallet, deliveryLocationView, deliveryTimeView, detail,
          hours, imgMerchant, ketsaldo, layoutContent, llAddMore, llbtn, llcheckedcash,
