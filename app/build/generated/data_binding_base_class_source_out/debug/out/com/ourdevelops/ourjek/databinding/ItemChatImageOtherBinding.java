...
public final class ItemChatImageOtherBinding implements ViewBinding {
  @NonNull
  ...
  private ItemChatImageOtherBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemChatImageOtherBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatImageOtherBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_image_other, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatImageOtherBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatImageOtherBinding((RelativeLayout) rootView, chatimage, datetxt,
          messageseen, notsend, progress);
    }
