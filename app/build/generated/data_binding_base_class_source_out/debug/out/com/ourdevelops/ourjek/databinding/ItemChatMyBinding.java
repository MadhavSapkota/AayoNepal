...
public final class ItemChatMyBinding implements ViewBinding {
  @NonNull
  ...
  private ItemChatMyBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemChatMyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemChatMyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_chat_my, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemChatMyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatMyBinding((RelativeLayout) rootView, datetxt, messageseen, msgtxt);
    }
