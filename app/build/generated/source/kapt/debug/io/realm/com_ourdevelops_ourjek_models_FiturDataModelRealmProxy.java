...
public class com_ourdevelops_ourjek_models_FiturDataModelRealmProxy extends com.ourdevelops.ourjek.models.FiturDataModel
    implements RealmObjectProxy, com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface {

    static final class FiturDataModelColumnInfo extends ColumnInfo {
        long idFiturColKey;
        long fiturColKey;
        long biayaColKey;
        ...
        FiturDataModelColumnInfo(OsSchemaInfo schemaInfo) {
            super(11);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("FiturDataModel");
        ...
        FiturDataModelColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new FiturDataModelColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final FiturDataModelColumnInfo src = (FiturDataModelColumnInfo) rawSrc;
            final FiturDataModelColumnInfo dst = (FiturDataModelColumnInfo) rawDst;
    ...
    private ProxyState<com.ourdevelops.ourjek.models.FiturDataModel> proxyState;

    com_ourdevelops_ourjek_models_FiturDataModelRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (FiturDataModelColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.ourdevelops.ourjek.models.FiturDataModel>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("FiturDataModel", 11, 0);
    ...
    public static FiturDataModelColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new FiturDataModelColumnInfo(schemaInfo);
    }
    ...
    @SuppressWarnings("cast")
    public static com.ourdevelops.ourjek.models.FiturDataModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ourdevelops.ourjek.models.FiturDataModel obj = null;
        if (update) {
            Table table = realm.getTable(com.ourdevelops.ourjek.models.FiturDataModel.class);
            FiturDataModelColumnInfo columnInfo = (FiturDataModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.FiturDataModel.class);
            ...
            if (colKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.FiturDataModel.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("idFitur")) {
                if (json.isNull("idFitur")) {
                    obj = (io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy) realm.createObjectInternal(com.ourdevelops.ourjek.models.FiturDataModel.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy) realm.createObjectInternal(com.ourdevelops.ourjek.models.FiturDataModel.class, json.getInt("idFitur"), true, excludeFields);
                }
            } else {
        ...
        final com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface objProxy = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) obj;
        if (json.has("fitur")) {
    ...
    public static com.ourdevelops.ourjek.models.FiturDataModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.ourdevelops.ourjek.models.FiturDataModel obj = new com.ourdevelops.ourjek.models.FiturDataModel();
        final com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface objProxy = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ourdevelops_ourjek_models_FiturDataModelRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.FiturDataModel.class), false, Collections.<String>emptyList());
        io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy obj = new io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ourdevelops.ourjek.models.FiturDataModel copyOrUpdate(Realm realm, FiturDataModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.FiturDataModel object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ourjek.models.FiturDataModel) cachedRealmObject;
        }

        com.ourdevelops.ourjek.models.FiturDataModel realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.ourdevelops.ourjek.models.FiturDataModel.class);
            long pkColumnKey = columnInfo.idFiturColKey;
            long colKey = table.findFirstLong(pkColumnKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$idFitur());
            if (colKey == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy();
    ...
    public static com.ourdevelops.ourjek.models.FiturDataModel copy(Realm realm, FiturDataModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.FiturDataModel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ourjek.models.FiturDataModel) cachedRealmObject;
        }

        com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface realmObjectSource = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) newObject;
        ...
        io.realm.com_ourdevelops_ourjek_models_FiturDataModelRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ourdevelops.ourjek.models.FiturDataModel object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnKey = columnInfo.idFiturColKey;
        long colKey = Table.NO_MATCH;
        Object primaryKeyValue = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$idFitur();
        if (primaryKeyValue != null) {
            colKey = Table.nativeFindFirstInt(tableNativePtr, pkColumnKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$idFitur());
        }
        if (colKey == Table.NO_MATCH) {
            colKey = OsObject.createRowWithPrimaryKey(table, pkColumnKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$idFitur());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, colKey);
        String realmGet$fitur = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$fitur();
        if (realmGet$fitur != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fiturColKey, colKey, realmGet$fitur, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.biayaColKey, colKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$biaya(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.biaya_minimumColKey, colKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$biaya_minimum(), false);
        String realmGet$keteranganBiaya = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$keteranganBiaya();
        ...
        String realmGet$keterangan = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$keterangan();
        ...
        String realmGet$diskon = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$diskon();
        if (realmGet$diskon != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.diskonColKey, colKey, realmGet$diskon, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.biayaAkhirColKey, colKey, ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$biayaAkhir(), false);
        String realmGet$icon = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$icon();
        if (realmGet$icon != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.iconColKey, colKey, realmGet$icon, false);
        }
        String realmGet$job = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$job();
        if (realmGet$job != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.jobColKey, colKey, realmGet$job, false);
        }
        String realmGet$home = ((com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) object).realmGet$home();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        FiturDataModelColumnInfo columnInfo = (FiturDataModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.FiturDataModel.class);
        long pkColumnKey = columnInfo.idFiturColKey;
        com.ourdevelops.ourjek.models.FiturDataModel object = null;
        while (objects.hasNext()) {
            object = (com.ourdevelops.ourjek.models.FiturDataModel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ourdevelops.ourjek.models.FiturDataModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ourdevelops.ourjek.models.FiturDataModel.class);
    ...
    public static com.ourdevelops.ourjek.models.FiturDataModel createDetachedCopy(com.ourdevelops.ourjek.models.FiturDataModel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ourdevelops.ourjek.models.FiturDataModel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ourdevelops.ourjek.models.FiturDataModel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ourdevelops.ourjek.models.FiturDataModel) cachedObject.object;
            }
            unmanagedObject = (com.ourdevelops.ourjek.models.FiturDataModel) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface unmanagedCopy = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) unmanagedObject;
        com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface realmSource = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) realmObject;
    ...
    static com.ourdevelops.ourjek.models.FiturDataModel update(Realm realm, FiturDataModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.FiturDataModel realmObject, com.ourdevelops.ourjek.models.FiturDataModel newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface realmObjectTarget = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) realmObject;
        com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface realmObjectSource = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ourdevelops.ourjek.models.FiturDataModel.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        builder.addInteger(columnInfo.idFiturColKey, realmObjectSource.realmGet$idFitur());
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("FiturDataModel = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_ourdevelops_ourjek_models_FiturDataModelRealmProxy aFiturDataModel = (com_ourdevelops_ourjek_models_FiturDataModelRealmProxy)o;

        BaseRealm realm = proxyState.getRealm$realm();
        BaseRealm otherRealm = aFiturDataModel.proxyState.getRealm$realm();
        ...
        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aFiturDataModel.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getObjectKey() != aFiturDataModel.proxyState.getRow$realm().getObjectKey()) return false;
