...
public class com_ourdevelops_ourjek_models_MerchantModelRealmProxy extends com.ourdevelops.ourjek.models.MerchantModel
    implements RealmObjectProxy, com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface {

    static final class MerchantModelColumnInfo extends ColumnInfo {
        ...
        MerchantModelColumnInfo(OsSchemaInfo schemaInfo) {
            super(13);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("MerchantModel");
        ...
        MerchantModelColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new MerchantModelColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final MerchantModelColumnInfo src = (MerchantModelColumnInfo) rawSrc;
            final MerchantModelColumnInfo dst = (MerchantModelColumnInfo) rawDst;
    ...
    private MerchantModelColumnInfo columnInfo;
    private ProxyState<com.ourdevelops.ourjek.models.MerchantModel> proxyState;

    com_ourdevelops_ourjek_models_MerchantModelRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (MerchantModelColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.ourdevelops.ourjek.models.MerchantModel>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("MerchantModel", 13, 0);
    ...
    public static MerchantModelColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new MerchantModelColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "MerchantModel";
    }

    @SuppressWarnings("cast")
    public static com.ourdevelops.ourjek.models.MerchantModel createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.ourdevelops.ourjek.models.MerchantModel obj = null;
        if (update) {
            Table table = realm.getTable(com.ourdevelops.ourjek.models.MerchantModel.class);
            MerchantModelColumnInfo columnInfo = (MerchantModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.MerchantModel.class);
            ...
            if (colKey != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(colKey), realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.MerchantModel.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id_merchant")) {
                if (json.isNull("id_merchant")) {
                    obj = (io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy) realm.createObjectInternal(com.ourdevelops.ourjek.models.MerchantModel.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy) realm.createObjectInternal(com.ourdevelops.ourjek.models.MerchantModel.class, json.getString("id_merchant"), true, excludeFields);
                }
            } else {
        ...
        final com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface objProxy = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) obj;
    ...
    public static com.ourdevelops.ourjek.models.MerchantModel createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.ourdevelops.ourjek.models.MerchantModel obj = new com.ourdevelops.ourjek.models.MerchantModel();
        final com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface objProxy = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_ourdevelops_ourjek_models_MerchantModelRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.MerchantModel.class), false, Collections.<String>emptyList());
        io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy obj = new io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.ourdevelops.ourjek.models.MerchantModel copyOrUpdate(Realm realm, MerchantModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.MerchantModel object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ourjek.models.MerchantModel) cachedRealmObject;
        }

        com.ourdevelops.ourjek.models.MerchantModel realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.ourdevelops.ourjek.models.MerchantModel.class);
            long pkColumnKey = columnInfo.id_merchantColKey;
            String value = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$id_merchant();
            long colKey = Table.NO_MATCH;
            if (value == null) {
                colKey = table.findFirstNull(pkColumnKey);
            } else {
            ...
            if (colKey == Table.NO_MATCH) {
                ...
                try {
                    ...
                    realmObject = new io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy();
    ...
    public static com.ourdevelops.ourjek.models.MerchantModel copy(Realm realm, MerchantModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.MerchantModel newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.ourdevelops.ourjek.models.MerchantModel) cachedRealmObject;
        }

        com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface realmObjectSource = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) newObject;
        ...
        io.realm.com_ourdevelops_ourjek_models_MerchantModelRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.ourdevelops.ourjek.models.MerchantModel object, Map<RealmModel,Long> cache) {
        ...
        MerchantModelColumnInfo columnInfo = (MerchantModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.MerchantModel.class);
        long pkColumnKey = columnInfo.id_merchantColKey;
        String primaryKeyValue = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$id_merchant();
        long colKey = Table.NO_MATCH;
        ...
        String realmGet$nama_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$nama_merchant();
        ...
        String realmGet$alamat_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$alamat_merchant();
        ...
        String realmGet$latitude_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$latitude_merchant();
        ...
        String realmGet$longitude_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$longitude_merchant();
        ...
        String realmGet$jam_buka = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$jam_buka();
        if (realmGet$jam_buka != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.jam_bukaColKey, colKey, realmGet$jam_buka, false);
        }
        String realmGet$jam_tutup = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$jam_tutup();
        ...
        String realmGet$deskripsi_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$deskripsi_merchant();
        ...
        String realmGet$category_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$category_merchant();
        ...
        String realmGet$foto_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$foto_merchant();
        ...
        String realmGet$telepon_merchant = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$telepon_merchant();
        ...
        String realmGet$status_promo = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$status_promo();
        ...
        String realmGet$distance = ((com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) object).realmGet$distance();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MerchantModelColumnInfo columnInfo = (MerchantModelColumnInfo) realm.getSchema().getColumnInfo(com.ourdevelops.ourjek.models.MerchantModel.class);
        long pkColumnKey = columnInfo.id_merchantColKey;
        com.ourdevelops.ourjek.models.MerchantModel object = null;
        while (objects.hasNext()) {
            object = (com.ourdevelops.ourjek.models.MerchantModel) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.ourdevelops.ourjek.models.MerchantModel object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.ourdevelops.ourjek.models.MerchantModel.class);
    ...
    public static com.ourdevelops.ourjek.models.MerchantModel createDetachedCopy(com.ourdevelops.ourjek.models.MerchantModel realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.ourdevelops.ourjek.models.MerchantModel unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.ourdevelops.ourjek.models.MerchantModel();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.ourdevelops.ourjek.models.MerchantModel) cachedObject.object;
            }
            unmanagedObject = (com.ourdevelops.ourjek.models.MerchantModel) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface unmanagedCopy = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) unmanagedObject;
        com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface realmSource = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) realmObject;
    ...
    static com.ourdevelops.ourjek.models.MerchantModel update(Realm realm, MerchantModelColumnInfo columnInfo, com.ourdevelops.ourjek.models.MerchantModel realmObject, com.ourdevelops.ourjek.models.MerchantModel newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface realmObjectTarget = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) realmObject;
        com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface realmObjectSource = (com_ourdevelops_ourjek_models_MerchantModelRealmProxyInterface) newObject;
        Table table = realm.getTable(com.ourdevelops.ourjek.models.MerchantModel.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, flags);
        builder.addString(columnInfo.id_merchantColKey, realmObjectSource.realmGet$id_merchant());
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("MerchantModel = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_ourdevelops_ourjek_models_MerchantModelRealmProxy aMerchantModel = (com_ourdevelops_ourjek_models_MerchantModelRealmProxy)o;

        BaseRealm realm = proxyState.getRealm$realm();
        BaseRealm otherRealm = aMerchantModel.proxyState.getRealm$realm();
        ...
        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aMerchantModel.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getObjectKey() != aMerchantModel.proxyState.getRow$realm().getObjectKey()) return false;
