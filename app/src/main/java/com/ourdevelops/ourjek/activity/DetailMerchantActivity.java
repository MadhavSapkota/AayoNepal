...
import com.ourdevelops.ourjek.item.CatItemItem;
    ...
    public void calculatePrice() {
        ...
        if (quantity > 0) {
            ...
            pricecountainer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (tutupki.equals("0")) {
                        Log.d("value", hours.getText().toString());
//                        Intent i = new Intent(DetailMerchantActivity.this, DetailOrderActivity.class); // old code
                        Intent i = new Intent(DetailMerchantActivity.this, NewDetailOrderActivity.class);
                        ...
                        i.putExtra("hour", hours.getText().toString());
                        i.putExtra("category", kategori.getText().toString());
