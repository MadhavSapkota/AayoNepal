...
object CustomDialogYes {
    ...
    @JvmStatic
    fun setTitle(title: String?): CustomDialogYes{
        if (title != null) {
            this.title = title
        }
        return this
    ...
    @JvmStatic
    fun setMessage(message: String?): CustomDialogYes{
        if (message != null){
    ...
    @JvmStatic
    fun setBtnText(text: String?): CustomDialogYes{
        if (text != null) {
            this.btn_text = text
        }
        return this
    ...
    fun showYesDialog(activity: Activity, callBack : dialogOnClickListener){
        ...
        dialog.setContentView(R.layout.custom_dialogbox_yes)
